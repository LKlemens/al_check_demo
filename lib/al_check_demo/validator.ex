defmodule AlCheckDemo.Validator do
  ...
  """
  # DEMO: @spec declares String.t() but the implementation returns integer().
  # Dialyzer surfaces this as a contract/success-typing violation.
  @spec clamp(integer(), integer(), integer()) :: String.t()
